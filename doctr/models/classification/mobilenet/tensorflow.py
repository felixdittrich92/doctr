...
default_cfgs: Dict[str, Dict[str, Any]] = {
    "mobilenet_v3_large": {
        ...
        "url": "https://github.com/mindee/doctr/releases/download/v0.8.1/mobilenet_v3_large-b9b66d7a.h5",
    },
    "mobilenet_v3_large_r": {
        "mean": (0.694, 0.695, 0.693),
        "std": (0.299, 0.296, 0.301),
        "input_shape": (32, 32, 3),
        "classes": list(VOCABS["french"]),
        "url": "https://github.com/mindee/doctr/releases/download/v0.8.1/mobilenet_v3_large_r-87708832.h5",
    },
    "mobilenet_v3_small": {
        "mean": (0.694, 0.695, 0.693),
        "std": (0.299, 0.296, 0.301),
        "input_shape": (32, 32, 3),
        "classes": list(VOCABS["french"]),
        "url": "https://github.com/mindee/doctr/releases/download/v0.8.1/mobilenet_v3_small-3036b3c2.h5",
    },
    "mobilenet_v3_small_r": {
        "mean": (0.694, 0.695, 0.693),
        "std": (0.299, 0.296, 0.301),
        "input_shape": (32, 32, 3),
        "classes": list(VOCABS["french"]),
        "url": "https://github.com/mindee/doctr/releases/download/v0.8.1/mobilenet_v3_small_r-f772fd05.h5",
    },
    "mobilenet_v3_small_crop_orientation": {
        "mean": (0.694, 0.695, 0.693),
        "std": (0.299, 0.296, 0.301),
        ...
        "classes": [0, -90, 180, 90],
        "url": "https://github.com/mindee/doctr/releases/download/v0.8.1/mobilenet_v3_small_crop_orientation-e37fca7e.h5",
    },
    "mobilenet_v3_small_page_orientation": {
        "mean": (0.694, 0.695, 0.693),
        "std": (0.299, 0.296, 0.301),
