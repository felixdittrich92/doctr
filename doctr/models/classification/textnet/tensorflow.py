...
default_cfgs: Dict[str, Dict[str, Any]] = {
    "textnet_tiny": {
        ...
        "url": "https://github.com/mindee/doctr/releases/download/v0.8.1/textnet_tiny-a29eeb4a.weights.h5",
    },
    "textnet_small": {
        "mean": (0.694, 0.695, 0.693),
        "std": (0.299, 0.296, 0.301),
        "input_shape": (32, 32, 3),
        "classes": list(VOCABS["french"]),
        "url": "https://github.com/mindee/doctr/releases/download/v0.8.1/textnet_small-1c2df0e3.weights.h5",
    },
    "textnet_base": {
        "mean": (0.694, 0.695, 0.693),
        "std": (0.299, 0.296, 0.301),
        "input_shape": (32, 32, 3),
        "classes": list(VOCABS["french"]),
        "url": "https://github.com/mindee/doctr/releases/download/v0.8.1/textnet_base-8b4b89bc.weights.h5",
    },
}
