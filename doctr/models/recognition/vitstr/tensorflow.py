...
default_cfgs: Dict[str, Dict[str, Any]] = {
    "vitstr_small": {
        ...
        "vocab": VOCABS["french"],
        "url": "https://github.com/mindee/doctr/releases/download/v0.8.1/vitstr_small-d28b8d92.weights.h5",
    },
    "vitstr_base": {
        "mean": (0.694, 0.695, 0.693),
        "std": (0.299, 0.296, 0.301),
        "input_shape": (32, 128, 3),
        "vocab": VOCABS["french"],
        "url": "https://github.com/mindee/doctr/releases/download/v0.8.1/vitstr_base-9ad6eb84.weights.h5",
    },
}
