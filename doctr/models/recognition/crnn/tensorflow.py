...
default_cfgs: Dict[str, Dict[str, Any]] = {
    "crnn_vgg16_bn": {
        ...
        "url": "https://github.com/mindee/doctr/releases/download/v0.8.1/crnn_vgg16_bn-9c188f45.weights.h5",
    },
    "crnn_mobilenet_v3_small": {
        ...
        "input_shape": (32, 128, 3),
        "vocab": VOCABS["french"],
        "url": "https://github.com/mindee/doctr/releases/download/v0.8.1/crnn_mobilenet_v3_small-54850265.weights.h5",
    },
    "crnn_mobilenet_v3_large": {
        ...
        "input_shape": (32, 128, 3),
        "vocab": VOCABS["french"],
        "url": "https://github.com/mindee/doctr/releases/download/v0.8.1/crnn_mobilenet_v3_large-c64045e5.weights.h5",
    },
}
