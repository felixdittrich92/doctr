...
default_cfgs: Dict[str, Dict[str, Any]] = {
    "linknet_resnet18": {
        ...
        "url": "https://github.com/mindee/doctr/releases/download/v0.8.1/linknet_resnet18-eebdd5ef.h5",
    },
    "linknet_resnet34": {
        "mean": (0.798, 0.785, 0.772),
        "std": (0.264, 0.2749, 0.287),
        "input_shape": (1024, 1024, 3),
        "url": "https://github.com/mindee/doctr/releases/download/v0.8.1/linknet_resnet34-dab1c82c.h5",
    },
    "linknet_resnet50": {
        "mean": (0.798, 0.785, 0.772),
        "std": (0.264, 0.2749, 0.287),
        "input_shape": (1024, 1024, 3),
        "url": "https://github.com/mindee/doctr/releases/download/v0.8.1/linknet_resnet50-cee0b1cc.h5",
    },
}
